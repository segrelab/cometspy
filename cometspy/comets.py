...
__license__ = "MIT"
__version__ = "0.6.3"
__comets_compatibility__ = "2.12.5" # version of comets this was tested with (except signaling)
__comets_compatibility_signaling__ = "2.12.5" # version signaling was tested with
